...
@Component({
  ...
  template: `
    <div class="container py-12 flex justify-center">
      <div class="card p-8" style="max-width: 580px; width: 100%;">
        ...
        <div *ngIf="pagoExitoso" class="text-center py-6">
          ...
          <div class="p-4 rounded-xl text-left mb-6" style="background: var(--table-th-bg); border: 1px solid var(--border-color);">
            <div class="flex justify-between py-1 text-xs" style="color: var(--text-muted);">
          ...
          <div class="flex flex-col sm:flex-row gap-3">
            <a routerLink="/mis-compras" class="btn btn-primary" style="flex: 1; padding: 0.75rem; text-align: center;">
              <i class="fa-solid fa-bag-shopping"></i> Ver Mis Compras
            </a>
            <a routerLink="/catalogo" class="btn btn-outline" style="flex: 1; padding: 0.75rem; text-align: center;">
        ...
        <div *ngIf="!pagoExitoso">
          ...
          <div class="mb-5">
            <label class="form-label mb-2">Selecciona tu Método de Pago</label>
            <div class="grid grid-cols-2 gap-3">
              <button 
                type="button"
                (click)="metodoPago = 'tarjeta_credito'" 
                class="p-3 rounded-lg text-left flex items-center gap-2.5"
          ...
          <div *ngIf="metodoPago === 'tarjeta_credito' || metodoPago === 'tarjeta_debito'" class="flex flex-col gap-3 mb-5 p-4 rounded-xl" style="background: var(--table-th-bg); border: 1px solid var(--border-color);">
          ...
          <div *ngIf="metodoPago === 'qr'" class="text-center p-6 rounded-xl mb-5" style="background: var(--table-th-bg); border: 1px solid var(--border-color);">
